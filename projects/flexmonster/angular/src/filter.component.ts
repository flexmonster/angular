...
export class FMFilter implements AfterViewInit {
  @Input() state: StateInputParams | undefined;
  @Input() options: IFMFilterInputParams | undefined;
  @Input() fieldName: string | undefined;

  protected root: HTMLElement;
  public filter!: IFMPivotFilter | IFMFlatFilter;
  ...
  ngAfterViewInit() {
    ...
    this.filter = Filter(container, { state: this.state, options: this.options, fieldName: this.fieldName! });
  }
